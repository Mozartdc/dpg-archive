...
<p style="margin: 0 0 1em 0;">FP-60X도 스피커가 상단에 배치되어 있지만,만, SuperNATURAL 기반의 샘플링과 모델링 혼합형이라서 FP-90X가 더 입체적이고 공명감 있는 소리를 냄. FP-90X는 더 큰 하우징과 4스피커 구조 덕분에 스피커로 들었을 때 공간감과 밀도에서도 차이가 남.</p>


### 디자인 및 조작부

<p style="margin: 0 0 1em 0;">외형은 기존 FP-90의 하우징을 그대로 가져오고, FP-60X와 비슷한 계열의 디자인이지만, 전체 크기와 무게가 더 크고 상위 모델다운 존재감이 있음. 전면 스피커 그릴과 넓은 조작부, 보강된 섀시 구조를 적용해 전체적인 완성도가 높음. 색상은 검정색과 흰색 두 가지로 출시됨.</p>
...
<p style="margin: 0 0 1em 0;">버튼 조작감도 좋음. 탄성 코일 스프링을 넣어 눌렀을 때 반응이 분명하고, 버튼 외곽에는 백라이트가 있어 어두운 환경에서도 상태 확인이 쉬움. 라벨도 고대비 색상과 읽기 쉬운 글꼴을 사용해 가독성이 좋음.</p>
...
<p style="margin: 0 0 1em 0;">연결 단자는 MIDI In Out, 스테레오 라인 출력 6.3mm L Mono R, USB Computer Type B, USB Memory Type A, 오디오 입력 3.5mm, 헤드폰 단자 2개 6.3mm와 3.5mm, 마이크 입력 단자를 제공함. Bluetooth MIDI와 Bluetooth Audio도 지원함.</p>


### 타 브랜드 비교 모델

<p style="margin: 0 0 1em 0;">Yamaha P-525, Kawai ES920</p>
...
<p style="margin: 0 0 1em 0;">트랜스포즈 설정, 스플릿 및 레이어 설정, 건반 터치 감도 Key Touch와 Hammer Response 조절, Ambience 설정, 3밴드 EQ 조절, Registration 설정 관리</p>
...
<p style="margin: 0 0 1em 0;">Pure Acoustic Piano 음색의 세부 파라미터 조정 가능</p>

<p style="margin: 0 0 1em 0;">Lid, Key Off Noise, Hammer Noise, Duplex Scale, String Resonance, Key Off Resonance, Cabinet Resonance, Soundboard Type, Damper Noise, Soft Pedal Type, Single Note Tuning, Single Note Volume, Single Note Character</p>

<p style="margin: 0 0 1em 0;">My Stage</p>

<p style="margin: 0 0 1em 0;">Roland에서 제공하는 피아노 모델링 프리셋 조합을 빠르게 선택 가능</p>
...
<p style="margin: 0 0 1em 0;">MIDI 연주 녹음 및 재생 관리, 녹음된 곡 관리 기능</p>
