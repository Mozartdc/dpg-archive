...
notionPageId: "3b826dfb-cd79-8115-91bb-fea049158908"
tags:
...
<img src="/images/2.3.-고트프리트-질버만의-개량과-독일-지역으로의-확산-0.png" alt="" style="max-width: 100%; height: auto; border-radius: 4px; display: block; margin: 10px 0;" />
...
<a href="https://www.denzilwraight.com/Maffei.pdf?utm_source=perplexity" target="_blank" style="display: block; border: 1px solid #e5e7eb; border-radius: 6px; text-decoration: none; color: inherit; margin: 16px 0; padding: 16px; background: white; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
  <div style="font-size: 14px; font-weight: 600; margin-bottom: 6px; color: #111827; word-break: break-all; overflow-wrap: anywhere;">🔗 https://www.denzilwraight.com/Maffei.pdf?utm_source=perplexity</div>
  
  <div style="font-size: 11px; color: #9ca3af; word-break: break-all;">https://www.denzilwraight.com/Maffei.pdf?utm_source=perplexity</div>
</a>



<img src="/images/2.3.-고트프리트-질버만의-개량과-독일-지역으로의-확산-1.webp" alt="2.3. 고트프리트 질버만의 개량과 독일 지역으로의 확산 이미지 1" style="max-width: 100%; height: auto; border-radius: 4px; display: block; margin: 10px 0;" />
...
<img src="/images/2.3.-고트프리트-질버만의-개량과-독일-지역으로의-확산-2.jpg" alt="2.3. 고트프리트 질버만의 개량과 독일 지역으로의 확산 이미지 2" style="max-width: 100%; height: auto; border-radius: 4px; display: block; margin: 10px 0;" />
...
<div style="position: relative; width: 100%; padding-bottom: 56.25%; height: 0; overflow: hidden; border-radius: 8px;">
  <iframe src="https://www.youtube.com/embed/OX4_CwLcl4M" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;" frameborder="0" allowfullscreen></iframe>
</div>
...
<img src="/images/2.3.-고트프리트-질버만의-개량과-독일-지역으로의-확산-3.png" alt="" style="max-width: 100%; height: auto; border-radius: 4px; display: block; margin: 10px 0;" />
