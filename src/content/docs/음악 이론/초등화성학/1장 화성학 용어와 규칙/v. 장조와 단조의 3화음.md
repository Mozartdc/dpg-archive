...
<p style="margin-bottom: 1em;"><strong>화음의 표기 규칙</strong></p>

<p style="margin-bottom: 1em;">이렇게 만들어진 화음은 로마자 숫자로 순서대로 이름을 붙이는데, 3화음의 성질(장, 단, 증, 감)을 한눈에 알 수 있도록 대문자와 소문자, 그리고 기호를 구별하여 표시함.</p>
...
<p style="margin-bottom: 1em;">장3화음 (Major)은 대문자 
단3화음 (Minor)은 소문자
...
| 기호<br>(장/단/증/감) | 한글 | 영문 |
| --- | --- | --- |
| <strong>I / i</strong> | 으뜸화음 | Tonic Triad |
| <strong>ii / ii°</strong> | 윗으뜸화음 | Supertonic Triad |
| <strong>iii / III⁺</strong> | 가온화음 | Mediant Triad |
| <strong>IV / iv</strong> | 버금딸림화음 | Subdominant Triad |
| <strong>V / V</strong> | 딸림화음 | Dominant Triad |
