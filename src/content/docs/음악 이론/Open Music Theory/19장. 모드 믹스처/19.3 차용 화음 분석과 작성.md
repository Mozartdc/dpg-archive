...
세컨더리 화음와는 달리, <a href="/음악-이론/open-music-theory/19장-모드-믹스처/191-모드-믹스처/" style="color: inherit; text-decoration: underline;">차용 화음</a>은 로마 숫자 분석에서 근음(root), 화음의 성질(quality), 전위(inversion)만 명시하면 됨.
