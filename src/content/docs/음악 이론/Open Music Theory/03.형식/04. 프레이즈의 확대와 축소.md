...
<a href="https://viva.pressbooks.pub/openmusictheory/chapter/expansion-and-contraction/" target="_blank" style="display: flex; border: 1px solid #e5e7eb; border-radius: 6px; text-decoration: none; color: inherit; margin: 16px 0; overflow: hidden; background: white; box-shadow: 0 1px 2px rgba(0,0,0,0.05);">
  ...
  <div style="width: 140px; min-width: 140px; background: #f3f4f6; overflow: hidden;">
    <img src="/images/04.-프레이즈의-확대와-축소-2.png" alt="" style="width: 100%; height: 100%; object-fit: cover; display: block;" />
  </div>
</a>
...
<img src="/images/04.-프레이즈의-확대와-축소-3.png" alt="" style="max-width: 100%; height: auto; border-radius: 4px; display: block; margin: 10px 0;" />
