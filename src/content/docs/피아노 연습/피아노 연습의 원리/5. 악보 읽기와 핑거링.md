...
notionPageId: "2ff26dfb-cd79-808f-b695-cff8cc27d507"
tags:
  - "피아노 연습"
  - "피아노교재"
sidebar:
...
<strong>악보 읽기는 초반에 누구나 막히는 구간임.</strong>
...
<strong>음악기호는 한꺼번에 외우려고 따로 공부할 필요는 없음. </strong>
...
<strong>악보에서 조표와 박자표는 시작 부분에서 꼭 확인해야 함.</strong>
...
<strong>핑거링의 가장 큰 원칙은 같은 구절, 비슷한 구절에서는 항상 같은 번호를 쓰는 것임.</strong>

핑거링을 한 번 정하면 쉽게 바꾸지 않는 게 좋음. 중간에 바꾸면 기존 습관을 지우는 데 시간이 많이 들고, 연주 중에는 예전 습관이 튀어나와 실수로 이어지기 쉬움. 

스케일이나 단순한 진행에 쓰는 표준 핑거링은 악보에서 생략하는 경우가 많음. 앞뒤 연결 때문에 표준 핑거링을 그대로 쓰기 어려울 때도 있음. 악보가 핑거링을 따로 제시했다면 비표준 핑거링일 가능성이 큼. 그래서 처음엔 어색해 보일 수 있는데, 속도를 올리고 양손을 합쳐 치기 시작하면 왜 그게 필요한지 체감하게 됨.
...
<img src="/images/5.-악보-읽기와-핑거링-0.png" alt="" style="max-width: 100%; height: auto; border-radius: 4px; display: block; margin: 10px 0;" />
